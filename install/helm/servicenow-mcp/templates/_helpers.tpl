...
helm.sh/chart: {{ include "servicenow-mcp.chart" . }}
...
*/}}
{{- define "servicenow-mcp.serviceAccountName" -}}
{{- if .Values.serviceAccount.create }}
{{- default (include "servicenow-mcp.fullname" .) .Values.serviceAccount.name }}
{{- else }}
...
ArgoCD Syncwave
*/}}
{{- define "servicenow-mcp.argocd-syncwave" -}}
{{- if .Values.argocd }}
